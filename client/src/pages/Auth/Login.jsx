...
const Login = () => {
    ...
    return (
        ...
        <div className="w-full h-screen bg-cover bg-center relative flex justify-center items-center pt-10">
            ...
            <div className="max-w-lg md:w-lg px-5 md:px-0 bg-gray-100/30 backdrop-blur-[2px] shadow-lg border border-[#f2f2f2]  z-30 flex flex-col items-center gap-7 py-10 rounded-4xl h-fit">
                <div className="text-center">
                    <p className="font-bold text-blue-500 text-lg">Login</p>
                    <p className="text-gray-600">Welcome back! Sign in using your <br />social account or email to contain us</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-2 items-center">
                    ...
                    <button type="submit" className="p-2 px-5 shadow-lg border border-[#fefefe] font-semibold text-lg rounded bg-[#f9f9f9] w-fit ">Login</button>
                </form>
